  ...
  handClick(e) {
    switch (e) {
      case 'GeShi':
        {
          //备注第三个参数必须穿入字符串
          AliyunOSS.asyncDownload('luozhang002', 'yanxing', '', {
      ...
      case 'ShuiYin':
        {
          let xOss =
            'image/resize,w_400/watermark,image_cGFuZGEucG5nP3gtb3NzLXByb2Nlc3M9aW1hZ2UvcmVzaXplLFBfMzA,t_90,g_se,x_10,y_10';
          AliyunOSS.asyncDownload('luozhang002', 'zhongji', '', {
            'x-oss-process': xOss,
          })
            .then(e => {
              Alert.alert(e);
