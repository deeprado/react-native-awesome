...
class AccountMobile extends Component {
  ...
  renderCenterComponent() {
    return (
      <View>
        <Text style={{color: '#000', fontSize: 24}}>更换手机号</Text>
      </View>
    );
  }
  ...
  bindNew() {
    ...
    Toast.loading('处理中...', 1, () => {
      if (false) {
        ...
        this.props.navigation.navigate('AccountMobileChange');
      }
      //
    });
  }
    ...
    if (this.state.mobileFlag && this.state.codeFlag) {
      ...
      return (
        <View
          ...
          <TouchableOpacity onPress={() => this.bindNew()}>
            <View
              style={{
                flexDirection: 'row',
                justifyContent: 'center',
